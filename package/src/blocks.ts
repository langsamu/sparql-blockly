...
Blockly.Blocks["sparql11_selectclause"] = {
    init: function () {
        this.appendStatementInput("vars")
            .setCheck("VarOrExpressionAsVarItem")
            .appendField(new Blockly.FieldDropdown([["", ""], ["DISTINCT", "DISTINCT"], ["REDUCED", "REDUCED"]]), "distinctOrReduced")
            .appendField(new Blockly.FieldDropdown([["", ""], ["*", "*"]]), "star")
...
Blockly.Blocks["sparql11_expressionasvar"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_selectquery"] = {
    init: function () {
...
Blockly.Blocks["sparql11_describequery"] = {
    init: function () {
...
Blockly.Blocks["sparql11_prefixedname"] = {
    init: function () {
        this.appendDummyInput()
            .appendField(":")
        this.setInputsInline(true)
        this.setOutput(true, ["EmbSubjectOrObject", "DataValueTerm", "VarOrTermOrEmbTP", "iri", "VarOrIri", "GraphNode", "VarOrTerm", "GraphTerm", "Verb", "DataBlockValue", "PathPrimary", "PathElt", "PathEltOrInverse", "PathSequence", "PathAlternative", "Path", "VerbPath", "PathOneInPropertySet", "PathNegatedPropertySet", "Expression", "ConditionalOrExpression", "ConditionalAndExpression", "ValueLogical", "RelationalExpression", "NumericExpression", "AdditiveExpression", "MultiplicativeExpression", "UnaryExpression", "PrimaryExpression", "iriOrFunction", "GraphOrDefault"])
        this.setColour(326)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_prefixednameprefix"] = {
    init: function () {
        this.appendDummyInput()
...
Blockly.Blocks["sparql11_prefixednamelocalname"] = {
    init: function () {
        this.appendDummyInput()
            .appendField(":")
            .appendField(new Blockly.FieldTextInput(""), "localName")
        this.setInputsInline(true)
        this.setOutput(true, ["EmbSubjectOrObject", "DataValueTerm", "VarOrTermOrEmbTP", "iri", "VarOrIri", "GraphNode", "VarOrTerm", "GraphTerm", "Verb", "DataBlockValue", "PathPrimary", "PathElt", "PathEltOrInverse", "PathSequence", "PathAlternative", "Path", "VerbPath", "PathOneInPropertySet", "PathNegatedPropertySet", "Expression", "ConditionalOrExpression", "ConditionalAndExpression", "ValueLogical", "RelationalExpression", "NumericExpression", "AdditiveExpression", "MultiplicativeExpression", "UnaryExpression", "PrimaryExpression", "iriOrFunction", "GraphOrDefault"])
        this.setColour(326)
        this.setTooltip("")
...
Blockly.Blocks["sparql11_prefixednameprefixlocalname"] = {
    init: function () {
        this.appendDummyInput()
            .appendField(new Blockly.FieldTextInput(""), "prefix")
            .appendField(":")
...
Blockly.Blocks["sparql11_iriref"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("<")
            ...
            .appendField(">")
        this.setInputsInline(true)
        this.setOutput(true, ["EmbSubjectOrObject", "DataValueTerm", "VarOrTermOrEmbTP", "IRIREF", "iri", "VarOrIri", "GraphNode", "VarOrTerm", "GraphTerm", "Verb", "DataBlockValue", "PathPrimary", "PathElt", "PathEltOrInverse", "PathSequence", "PathAlternative", "Path", "VerbPath", "PathOneInPropertySet", "PathNegatedPropertySet", "Expression", "ConditionalOrExpression", "ConditionalAndExpression", "ValueLogical", "RelationalExpression", "NumericExpression", "AdditiveExpression", "MultiplicativeExpression", "UnaryExpression", "PrimaryExpression", "iriOrFunction", "GraphOrDefault"])
        this.setColour(326)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_irirefdefault"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("<>")
        this.setInputsInline(true)
...
Blockly.Blocks["sparql11_solutionmodifier"] = {
    init: function () {
...
Blockly.Blocks["sparql11_subselect"] = {
    init: function () {
        this.appendValueInput("select")
            .setCheck("SelectClause")
            .appendField("SELECT")
...
Blockly.Blocks["sparql11_typedliteral"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("string")
...
Blockly.Blocks["sparql11_a"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("a")
        this.setOutput(true, ["a", "PathPrimary", "PathElt", "PathEltOrInverse", "PathSequence", "PathAlternative", "Path", "VerbPath", "PathOneInPropertySet", "PathNegatedPropertySet", "Verb"])
        this.setColour(228)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_blanknodepropertylist"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("[")
...
Blockly.Blocks["sparql11_collection"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("(")
...
Blockly.Blocks["sparql11_blanknodelabel"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("_:")
            .appendField(new Blockly.FieldTextInput(""), "value")
...
Blockly.Blocks["sparql11_var1"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("?")
            .appendField(new Blockly.FieldTextInput("s"), "value")
        this.setInputsInline(false)
        this.setOutput(true, ["EmbSubjectOrObject", "VarOrTermOrEmbTP", "Var", "VarOrIri", "Verb", "VarOrTerm", "GraphNode", "Object", "GroupCondition", "Expression", "ConditionalOrExpression", "ConditionalAndExpression", "ValueLogical", "RelationalExpression", "NumericExpression", "AdditiveExpression", "MultiplicativeExpression", "UnaryExpression", "PrimaryExpression"])
        this.setColour(33)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_groupconditionitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_groupgraphpattern"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("{")
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_groupgraphpatternsub"] = {
    init: function () {
        this.appendStatementInput("items")
...
Blockly.Blocks["sparql11_groupgraphpatternsubitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_optionalgraphpattern"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("GroupGraphPattern")
...
Blockly.Blocks["sparql11_graphgraphpattern"] = {
    init: function () {
...
Blockly.Blocks["sparql11_servicegraphpattern"] = {
    init: function () {
        this.appendValueInput("iri")
            .setCheck("VarOrIri")
            .appendField("SERVICE")
            .appendField(new Blockly.FieldDropdown([["", ""], ["SILENT", "SILENT"]]), "silent")
        this.appendValueInput("patterns")
            .setCheck("GroupGraphPattern")
...
Blockly.Blocks["sparql11_minusgraphpattern"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("GroupGraphPattern")
            .appendField("MINUS")
...
Blockly.Blocks["sparql11_grouporuniongraphpattern"] = {
    init: function () {
        this.appendStatementInput("items")
...
Blockly.Blocks["sparql11_filter"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("Constraint")
            .appendField("FILTER")
...
Blockly.Blocks["sparql11_inlinedata"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("DataBlock")
            .appendField("VALUES")
...
Blockly.Blocks["sparql11_inlinedataonevar"] = {
    init: function () {
...
Blockly.Blocks["sparql11_inlinedatafull"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("(")
...
Blockly.Blocks["sparql11_datablockvaluesitem"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("(")
        this.appendStatementInput("items")
...
Blockly.Blocks["sparql11_datablockvalueitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_negatedpath"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("PathNegatedPropertySet")
            .appendField("!")
        this.setInputsInline(true)
        this.setOutput(true, ["PathPrimary", "PathElt", "PathEltOrInverse", "PathSequence", "PathAlternative", "Path", "VerbPath"])
        this.setColour(228)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_bracketedpath"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("Path")
            .appendField("(")
...
Blockly.Blocks["sparql11_pathwithmodifier"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("PathPrimary")
            .appendField("")
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown([["", ""], ["?", "?"], ["*", "*"], ["+", "+"]]), "modifier")
        this.setInputsInline(true)
        this.setOutput(true, ["PathElt", "PathEltOrInverse", "PathSequence", "PathAlternative", "Path", "VerbPath"])
        this.setColour(228)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_inversepath"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("PathElt")
            .appendField("^")
        this.setInputsInline(false)
        this.setInputsInline(true)
        this.setOutput(true, ["PathEltOrInverse", "PathSequence", "PathAlternative", "Path", "VerbPath"])
        this.setColour(228)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_pathalternative"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("|")
        this.appendStatementInput("items")
        ...
        this.setInputsInline(true)
        this.setOutput(true, ["PathAlternative", "Path", "VerbPath"])
        this.setColour(228)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_pathsequencitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_pathalternativeitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_pathsequence"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("/")
        this.appendStatementInput("items")
        ...
        this.setInputsInline(true)
        this.setOutput(true, ["PathSequence", "PathAlternative", "Path", "VerbPath"])
        this.setColour(228)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_inversepathoneinpropertyset"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck(["iri", "a"])
            .appendField("^")
...
Blockly.Blocks["sparql11_pathoneinpropertysetalternative"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("(|)")
        this.appendStatementInput("items")
...
Blockly.Blocks["sparql11_pathoneinpropertysetalternativeitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_varitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("Var")
        this.setInputsInline(false)
...
Blockly.Blocks["sparql11_askquery"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("QueryCommon")
            .appendField("ASK")
...
Blockly.Blocks["sparql11_simpleconstructquery"] = {
    init: function () {
        this.appendDummyInput()
...
Blockly.Blocks["sparql11_triplessamesubjectitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_constructquery"] = {
    init: function () {
...
Blockly.Blocks["sparql11_prefixdecl"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("IRIREF")
            .appendField("PREFIX")
...
Blockly.Blocks["sparql11_prologueitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_varorexpressionasvaritem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_booleanliteral"] = {
    init: function () {
        this.appendDummyInput()
...
Blockly.Blocks["sparql11_brackettedexpression"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("Expression")
            .appendField("(")
        this.appendDummyInput()
            .appendField(")")
        this.setOutput(true, ["BrackettedExpression", "PrimaryExpression", "UnaryExpression", "MultiplicativeExpression", "AdditiveExpression", "NumericExpression", "RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression", "Constraint"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_multiplicativeexpression"] = {
    init: function () {
        ...
        this.setInputsInline(true)
        this.setOutput(true, ["MultiplicativeExpression", "AdditiveExpression", "NumericExpression", "RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_additiveexpression"] = {
    init: function () {
        this.appendValueInput("left")
        ...
        this.appendValueInput("right")
            ...
            .appendField(new Blockly.FieldDropdown([["+", "+"], ["-", "-"]]), "operator")
        this.setInputsInline(true)
        this.setOutput(true, ["AdditiveExpression", "NumericExpression", "RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_relationalexpression"] = {
    init: function () {
        this.appendValueInput("left")
            .setCheck("NumericExpression")
        this.appendValueInput("right")
            .setCheck("NumericExpression")
            .appendField(new Blockly.FieldDropdown([["=", "="], ["!=", "!="], ["<", "<"], [">", ">"], ["<=", "<="], [">=", ">="]]), "operator")
        this.setInputsInline(true)
        this.setOutput(true, ["RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_relationalexpressionin"] = {
    init: function () {
        this.appendValueInput("left")
            .setCheck("NumericExpression")
        this.appendStatementInput("right")
            .setCheck("ExpressionListItem")
            .appendField(new Blockly.FieldDropdown([["IN", "IN"], ["NOT IN", "NOT IN"]]), "operator")
        this.setInputsInline(true)
        this.setOutput(true, ["RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression"])
        this.setColour(261)
        this.setTooltip("")
...
Blockly.Blocks["sparql11_expressionlistitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("Expression")
...
Blockly.Blocks["sparql11_conditionalandexpression"] = {
    init: function () {
        this.appendValueInput("left")
            .setCheck("ValueLogical")
        this.appendValueInput("right")
            .setCheck("ValueLogical")
            .appendField("&&")
        this.setInputsInline(true)
...
Blockly.Blocks["sparql11_conditionalorexpression"] = {
    init: function () {
        this.appendValueInput("left")
...
Blockly.Blocks["sparql11_string"] = {
    init: function () {
        this.appendDummyInput()
            .appendField(new Blockly.FieldMultilineInput(""), "value")
        this.setInputsInline(true)
        this.setOutput(true, ["EmbSubjectOrObject", "DataValueTerm", "VarOrTermOrEmbTP", "string", "RDFLiteral", "GraphNode", "VarOrTerm", "GraphTerm", "DataBlockValue", "Expression", "ConditionalOrExpression", "ConditionalAndExpression", "ValueLogical", "RelationalExpression", "NumericExpression", "AdditiveExpression", "MultiplicativeExpression", "UnaryExpression", "PrimaryExpression"])
        this.setColour(163)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_havingconditionitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("Constraint")
...
Blockly.Blocks["sparql11_triplessamesubject"] = {
    init: function () {
        this.appendValueInput("subject")
...
Blockly.Blocks["sparql11_varoririitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("VarOrIri")
...
Blockly.Blocks["sparql11_graphnodeitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("GraphNode")
...
Blockly.Blocks["sparql11_objectlistitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("GraphNode")
        this.setPreviousStatement(true, "ObjectListItem")
...
Blockly.Blocks["sparql11_propertylistnotempty"] = {
    init: function () {
        this.appendValueInput("predicate")
            .setCheck(["Verb", "Path"])
...
Blockly.Blocks["sparql11_querycommon"] = {
    init: function () {
        this.appendStatementInput("datasets")
            .setCheck("DatasetClause")
        this.appendValueInput("pattern")
...
Blockly.Blocks["sparql11_datasetclause"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_namedgraphclause"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("iri")
            .appendField("NAMED")
...
Blockly.Blocks["sparql11_builtincall0"] = {
    init: function () {
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown([["BNODE", "BNODE"], ["RAND", "RAND"], ["NOW", "NOW"], ["UUID", "UUID"], ["STRUUID", "STRUUID"]]), "operator")
            .appendField("()")
        this.setInputsInline(true)
        this.setOutput(true, ["BuiltInCall", "PrimaryExpression", "UnaryExpression", "MultiplicativeExpression", "AdditiveExpression", "NumericExpression", "RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression", "GroupCondition", "Constraint"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_builtincall2"] = {
    init: function () {
        this.appendValueInput("arg1")
            .setCheck("Expression")
            .appendField(new Blockly.FieldDropdown([["LANGMATCHES", "LANGMATCHES"], ["SUBSTR", "SUBSTR"], ["CONTAINS", "CONTAINS"], ["STRSTARTS", "STRSTARTS"], ["STRENDS", "STRENDS"], ["STRBEFORE", "STRBEFORE"], ["STRAFTER", "STRAFTER"], ["STRLANG", "STRLANG"], ["STRDT", "STRDT"], ["SAMETERM", "SAMETERM"], ["REGEX", "REGEX"]]), "operator")
            .appendField("(")
...
Blockly.Blocks["sparql11_builtincall3"] = {
    init: function () {
        this.appendValueInput("arg1")
            .setCheck("Expression")
            .appendField(new Blockly.FieldDropdown([["REGEX", "REGEX"], ["SUBSTR", "SUBSTR"], ["REPLACE", "REPLACE"], ["IF", "IF"], ["TRIPLE", "TRIPLE"]]), "operator")
            .appendField("(")
        this.appendValueInput("arg2")
            .setCheck("Expression")
            .appendField(",")
...
Blockly.Blocks["sparql11_builtincall4"] = {
    init: function () {
        this.appendValueInput("arg1")
            .setCheck("Expression")
            .appendField(new Blockly.FieldDropdown([["REPLACE", "REPLACE"]]), "operator")
            .appendField("(")
        this.appendValueInput("arg2")
            .setCheck("Expression")
            .appendField(",")
...
Blockly.Blocks["sparql11_builtincalln"] = {
    init: function () {
        this.appendStatementInput("args")
            .setCheck("ExpressionListItem")
            .appendField(new Blockly.FieldDropdown([["CONCAT", "CONCAT"], ["COALESCE", "COALESCE"]]), "operator")
            .appendField("(")
        this.appendDummyInput()
            .appendField(")")
        this.setInputsInline(true)
...
Blockly.Blocks["sparql11_iriorfunction"] = {
    init: function () {
        this.appendValueInput("iri")
            .setCheck("iri")
        this.appendDummyInput()
        ...
        this.appendDummyInput()
            .appendField(")")
        this.setInputsInline(true)
        this.setOutput(true, ["BuiltInCall", "PrimaryExpression", "UnaryExpression", "MultiplicativeExpression", "AdditiveExpression", "NumericExpression", "RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression", "Constraint", "GroupCondition"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_exists"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("GroupGraphPattern")
            .appendField(new Blockly.FieldDropdown([["EXISTS", "EXISTS"], ["NOT EXISTS", "NOT EXISTS"]]), "operator")
        this.setOutput(true, ["BuiltInCall", "PrimaryExpression", "UnaryExpression", "MultiplicativeExpression", "AdditiveExpression", "NumericExpression", "RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression", "GroupCondition", "Constraint"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
...
Blockly.Blocks["sparql11_unaryexpression"] = {
    init: function () {
        this.appendValueInput("left")
            .setCheck("PrimaryExpression")
            .appendField(new Blockly.FieldDropdown([["!", "!"], ["+", "+"], ["-", "UMINUS"]]), "operator")
        this.setInputsInline(true)
        this.setOutput(true, ["UnaryExpression", "MultiplicativeExpression", "AdditiveExpression", "NumericExpression", "RelationalExpression", "ValueLogical", "ConditionalAndExpression", "ConditionalOrExpression", "Expression"])
        this.setColour(261)
        this.setTooltip("")
        this.setHelpUrl("")
    }
...
Blockly.Blocks["sparql11_aggregate"] = {
    init: function () {
        this.appendValueInput("arg1")
            .setCheck("Expression")
            .appendField(new Blockly.FieldDropdown([["SUM", "SUM"], ["MIN", "MIN"], ["MAX", "MAX"], ["AVG", "AVG"], ["SAMPLE", "SAMPLE"]]), "operator")
            .appendField("(")
            .appendField(new Blockly.FieldDropdown([["", ""], ["DISTINCT", "DISTINCT"]]), "distinct")
        this.appendDummyInput()
            .appendField(")")
...
Blockly.Blocks["sparql11_group_concat"] = {
    init: function () {
        this.appendValueInput("arg1")
            .setCheck("Expression")
...
Blockly.Blocks["sparql11_prefixdecldefault"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("IRIREF")
            .appendField("PREFIX :")
...
Blockly.Blocks["sparql11_groupgraphpatternitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("GroupGraphPattern")
...
Blockly.Blocks["sparql11_orderconditionitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_ordercondition"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("BrackettedExpression")
            .appendField(new Blockly.FieldDropdown([["ASC", "ASC"], ["DESC", "DESC"]]), "operator")
...
Blockly.Blocks["sparql11_update"] = {
    init: function () {
        this.appendStatementInput("prologue")
            .setCheck("PrologueItem")
        this.appendStatementInput("items")
...
Blockly.Blocks["sparql11_updateitem"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck(["Update1"])
...
Blockly.Blocks["sparql11_graphref"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck("iri")
            .appendField("GRAPH")
...
Blockly.Blocks["sparql11_graphrefallnamed"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("NAMED")
...
Blockly.Blocks["sparql11_graphrefallall"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("ALL")
        this.setOutput(true, "GraphRefAll")
...
Blockly.Blocks["sparql11_graphordefault"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("DEFAULT")
...
Blockly.Blocks["sparql11_create"] = {
    init: function () {
...
Blockly.Blocks["sparql11_addmovecopy"] = {
    init: function () {
        this.appendValueInput("source")
            .setCheck("GraphOrDefault")
            .appendField(new Blockly.FieldDropdown([["ADD", "ADD"], ["MOVE", "MOVE"], ["COPY", "COPY"]]), "operator")
            .appendField(new Blockly.FieldDropdown([["", ""], ["SILENT", "SILENT"]]), "silent")
        this.appendValueInput("destination")
            .setCheck("GraphOrDefault")
            .appendField("TO")
...
Blockly.Blocks["sparql11_cleardrop"] = {
    init: function () {
        this.appendValueInput("graph")
            .setCheck("GraphRefAll")
            .appendField(new Blockly.FieldDropdown([["CLEAR", "CLEAR"], ["DROP", "DROP"]]), "operator")
            .appendField(new Blockly.FieldDropdown([["", ""], ["SILENT", "SILENT"]]), "silent")
        this.setOutput(true, "Update1")
        this.setColour(196)
        this.setTooltip("")
...
Blockly.Blocks["sparql11_quadpattern"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("{")
        this.appendStatementInput("items")
...
Blockly.Blocks["sparql11_quadpatternitem"] = {
    init: function () {
        this.appendValueInput("value")
...
Blockly.Blocks["sparql11_insertdeletewhere"] = {
    init: function () {
        this.appendValueInput("pattern")
            .setCheck("QuadPattern")
            .appendField(new Blockly.FieldDropdown([["INSERT DATA", "INSERT DATA"], ["DELETE DATA", "DELETE DATA"], ["DELETE WHERE", "DELETE WHERE"]]), "operator")
        this.setOutput(true, "Update1")
        this.setColour(196)
        this.setTooltip("")
        this.setHelpUrl("")
...
Blockly.Blocks["sparql11_quadsnottriples"] = {
    init: function () {
        this.appendValueInput("name")
            .setCheck("VarOrIri")
            .appendField("GRAPH {")
...
Blockly.Blocks["sparql11_modify"] = {
    init: function () {
        this.appendValueInput("iri")
            .setCheck("iri")
            .appendField("WITH")
...
Blockly.Blocks["sparql11_usingclause"] = {
    init: function () {
        this.appendValueInput("value")
            .setCheck(["iri", "NamedGraphClause"])
            .appendField("USING")
...
//console.log(Object.keys(Blockly.Blocks).filter(b => b.startsWith("sparql11_")))